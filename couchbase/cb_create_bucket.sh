...
######################################################
curl -u Administrator:maggie -X POST http://10.0.0.183:8091/pools/default/buckets -d name=bfpddata -d ramQuotaMB=2000 -d bucketType=couchbase -d authType=none
